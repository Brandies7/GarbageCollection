...
namespace GarbageCollection.Controllers
{
    public class PickupDaysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Day,CustomerId")] PickupDay pickupDay)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Day,CustomerId")] PickupDay pickupDay)
        {
            if (ModelState.IsValid)
            {
